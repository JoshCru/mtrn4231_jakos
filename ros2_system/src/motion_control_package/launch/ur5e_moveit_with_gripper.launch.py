...
def launch_setup(context, *args, **kwargs):
    ...
    # Package paths
    motion_control_pkg = get_package_share_directory("motion_control_package")
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("motion_control_package"), "urdf", "ur5e_with_end_effector.urdf.xacro"]),
            " ",
            "robot_ip:=", robot_ip,
            " ",
    ...
    robot_description_semantic_content = Command(
        [
            PathJoinSubstitution([FindExecutable(name="xacro")]),
            " ",
            PathJoinSubstitution([FindPackageShare("motion_control_package"), "srdf", "ur5e_with_gripper.srdf.xacro"]),
            " ",
            "name:=ur",
            " ",
            "prefix:=", prefix,
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("motion_control_package"), "config", "sorting_system.rviz"]
    )
    rviz_node = Node(
        package="rviz2",
