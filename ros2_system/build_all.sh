...
if [ $? -eq 0 ]; then
    ...
    echo "  ros2 launch supervisor_package supervisor.launch.py"
    echo "  ros2 launch perception_package perception.launch.py"
    echo "  ros2 launch recognition_module recognition.launch.py"
    echo "  ros2 launch planning_module planning.launch.py"
    echo "  ros2 launch control_package control.launch.py"
    echo "  ros2 launch motion_control_package motion_control.launch.py"
    echo ""
else
    echo ""
    echo -e "${RED}=========================================${NC}"
