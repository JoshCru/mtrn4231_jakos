...
# Check controller status (scaled_joint_trajectory_controller should already be active)
...
echo "[6/8] Starting Gripper Controller..."
wait_for_enter
...
# 8. Sorting Brain
echo "[8/8] Starting Sorting Brain..."
wait_for_enter
