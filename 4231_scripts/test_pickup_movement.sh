#!/bin/bash
# Test script for pickup movement - supports both fake and real UR5e

echo "======================================"
echo "UR5e Pickup Movement Test"
echo "======================================"
echo ""
...
if [ -z "$1" ]; then
    ...
    if [ "$choice" == "1" ]; then
        MODE="REAL"
        SETUP_SCRIPT="setupRealur5eSystemVisualisation.sh"
    elif [ "$choice" == "2" ]; then
        MODE="FAKE"
...
echo ""
echo "Testing pickup movement with $MODE UR5e"
echo ""
echo "This script will:"
echo "1. Check if the $MODE UR5e is running"
echo "2. Run the pickup movement sequence"
echo "   - Pick up point"
echo "   - Lift up point"
echo "   - Put down point"
echo ""
...
echo "Starting pickup movement sequence..."
echo ""

# Run the pickup movement script
python3 ros2_system/src/motion_control_module/scripts/pickup_movement.py
